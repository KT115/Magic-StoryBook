...
def init_state():
    for k, v in [("page", "ch1"), ("img", None), ("caption", ""), ("story", ""), ("audio", "")]:
...
def render_loading_1(proc, c_model):
    st.markdown("""
...
def render_loading_2(tok, s_model):
    st.markdown("""
    <div class="spell-chamber">
...
def main():
    ...
    if page == "ch1":
        ...
        render_loading_1(proc, c_model)
    elif page == "ch2":
        render_chapter_2()
    elif page == "load2":
        render_loading_2(tok, s_model)
    elif page == "ch3":
        render_chapter_3()
    elif page == "load3":
        render_loading_3()
